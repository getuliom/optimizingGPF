% Seeks to maximize both the average Fairness and Throughput by finding an
% optimized pair of α and β for the chosen scenario with an increasing
% number of users. This problem could be imagined as a black box system 
% with two inputs and two outputs. The inputs are set by the algorithm, 
% and the output is generated by the simulator.
%
% initial author: Getúlio Martins Resende
%
%% Parameters
clear
tic
